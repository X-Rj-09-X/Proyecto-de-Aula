...
public class ProyectoAula {
    ...
    static String[][] parqueadero = new String[6][5];
    static String[][] tipoEnPuesto = new String[6][5]; // "CARRO", "MOTO", "BICI", "DISCAP"
    static LocalDateTime[][] horaEntrada = new LocalDateTime[6][5];
    static boolean[][] pagado = new boolean[6][5];
 
    // Totales para contabilidad
    static double totalDia = 0; 
    static double totalSemana = 0;
    static double totalMes = 0;

    // Contador para numerar bicicletas (1,2,3,...)
    static int contadorBicicletas = 0;

    // Credenciales para admin/contabilidad
    ...
    // Formato de fecha corto: yyyy-MM-dd HH:mm:ss
    ...
    // Menú contabilidad (solo ver totales)
    ...
    // INGRESO CLIENTE: tipo, discapacitado, placa (si aplica), asignación automática según reglas
    public static void ingresoCliente() {
        ...
        if (tipo != 3) { // bicicletas no pueden ser discapacitado según requisitos
        ...
        String placa = "";
        if (tipo != 3) { // pedir placa solo para motos y carros
            System.out.print("\nIngrese placa: ");
